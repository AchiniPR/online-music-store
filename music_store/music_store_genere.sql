...
CREATE TABLE `genere` (
  `gID` int(11) NOT NULL,
  `gTitle` varchar(45) NOT NULL,
  `gDescription` varchar(500) NOT NULL,
  `gStylistic` varchar(100) NOT NULL,
  `gCultural` varchar(100) NOT NULL,
  `gInsutruments` varchar(100) NOT NULL,
  `gForms` varchar(100) NOT NULL,
  PRIMARY KEY (`gID`)
...
-- Dump completed on 2020-04-24  3:41:39
