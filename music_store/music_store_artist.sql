...
CREATE TABLE `artist` (
  ...
  `aDateOfBirth` varchar(12) NOT NULL,
  `aGeneres` varchar(200) NOT NULL,
  `aLabels` varchar(200) NOT NULL,
  `aPlayRole` varchar(100) NOT NULL,
  `aActiveYears` varchar(80) NOT NULL,
  PRIMARY KEY (`aID`)
...
-- Dump completed on 2020-04-24  3:41:38
